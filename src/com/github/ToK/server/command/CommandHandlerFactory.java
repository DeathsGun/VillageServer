...
public class CommandHandlerFactory {
    ...
    public CommandHandler getHandler(final String command, final String workingDir) {
        if(command.equalsIgnoreCase("SP-Erstellen")) {
        	...
        	return new Credits();
        } else if(command.equalsIgnoreCase("myip") || command.equalsIgnoreCase("whatismyip") || command.equalsIgnoreCase("ip")) {
        	return new MyIP();
        } else if(command.equalsIgnoreCase("RathhausB")) {
        	return new BuildMainhall();
        } 
